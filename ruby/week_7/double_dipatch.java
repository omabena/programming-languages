...
class Int extends Value {
	...
	/**
	 * other:= MyString
	 * return MyString.addInt(Int)
	 *
	 * other:= Int
	 * return:= Int.addInt(Int)
	 *
	 * other:= Rational
	 * return:= Rational.addInt(Int)
	 */
...
class MyString extends Value {
	...
	/**
	 * other:= Int
	 * return:= Int.addString(String)
	 *
	 * other:= MyString
	 * return:= MyString.addString(String)
	 *
	 * other:= Rational
	 * return:= Rationa.addString(String)
	 */
...
class Rational extends Value {
	...
	/**
	 * other:= MyString
	 * return MyString.addRational(MyRational)
	 * 
	 * other:= Int
	 * return Int.addRational(MyRational)
	 * 
	 * other:= MyRational
	 * return MyRational.addRational(MyRational)
	 */
